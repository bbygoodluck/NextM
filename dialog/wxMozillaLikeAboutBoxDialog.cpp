...
////@begin wxMozillaLikeAboutBoxDialog content construction
	...
	m_ContentPanel = new wxPanel(itemDialog1, ID_ContentPanel, wxDefaultPosition, SYMBOL_WXMOZILLALIKEABOUTBOXDIALOG_SIZE, wxNO_BORDER | wxTAB_TRAVERSAL);
	m_ContentPanel->SetBackgroundColour(this->GetBackgroundColour());// wxColour(210, 210, 210));
    ...
    itemStaticText8->SetForegroundColour(wxColour(10, 10, 255));
	itemStaticText8->SetFont(wxFont(12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, false, wxT("Arial")));
	...
	m_VersionStaticText->SetForegroundColour(wxColour(10, 10, 255));
	m_VersionStaticText->SetFont(wxFont(12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, false, wxT("Arial")));
